        ...
        <Accordion type="single" collapsible className="p-4 border rounded-lg">
          {Questions?.map((question) => (
            <AccordionItem key={question?.id} value={`item-${question?.id}`}>
              <AccordionTrigger className="lg:text-lg font-medium focus-visible:text-indigo-600 underline-offset-4 hover:text-indigo-600 decoration-wavy [&[data-state=open]]:text-indigo-600 [&[data-state=open]]:underline">
