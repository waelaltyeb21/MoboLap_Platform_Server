...
const NavBarLargeScreens = () => {
  return (
    <nav className="hidden sm:grid px-32 grid-cols-12 py-4 border-b border-b-slate-300">
      ...
      <ul className="col-span-3 flex items-center gap-4">
        <Button component={Link} href={`/compare`} variant="outline">
          <IconExchange />
...
const NavBarSmallScreens = () => {
  ...
  return (
    <nav className="flex items-center justify-between sm:hidden border-b border-b-slate-300 py-4 px-4">
