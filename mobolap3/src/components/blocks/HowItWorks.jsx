...
const HowItWorks = () => {
  ...
  return (
    <article className="How-It-Works my-40">
      <SectionHeading title={t("MainTitle")} subtitle={t("SubTitle")} />
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        {Steps?.map((step) => (
          <div
            key={step?.id}
            className="relative flex flex-col items-center justify-center text-center border p-4 rounded-lg cursor-pointer hover:-translate-y-4 smooth-transition"
          >
